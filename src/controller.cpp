...
int main (int argc, char *argv[]) {
	...
	// Init
	if (init_params(&params, &serial_stream, experiment_type, stimulation_type, n_in_chan, duration, freq, max_current, th_lo_per_pd, th_up_per_pd, th_lo_per_lp, th_up_per_lp) != OK) {
